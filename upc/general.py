...
import random
import threading
from upc import images_process as u
...
def toImgPIL(img_opencv): return Image.fromarray(cv2.cvtColor(img_opencv, cv2.COLOR_BGR2RGB))
...
class MergeThread(threading.Thread):
    def __init__(self, bgs, fgs, rotate=None, cutout_=False, save_path="", file_name="merged"):
